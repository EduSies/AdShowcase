        ...
        <div class="level mb-4">
            ...
            <div class="level-right">
                <a class="btn btn-outline-primary"
                   href="<?= Url::to(['back-office/device-create']) ?>"><?= Yii::t('app', 'New Device') ?></a>
            </div>
        </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'render' => new JsExpression('function (data,type,row) {
                        var editUrl = "' . Url::to(['back-office/device-update']) . '/" + row.id;
                        var delUrl  = "' . Url::to(['back-office/device-delete']) . '/" + row.id;
