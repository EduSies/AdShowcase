        ...
        <div class="level mb-4">
            ...
            <div class="level-right">
                <a class="btn btn-outline-primary"
                   href="<?= Url::to(['back-office/format-create']) ?>"><?= Yii::t('app', 'New Format') ?></a>
            </div>
        </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'render' => new JsExpression('function (data,type,row) {
                        var editUrl = "' . Url::to(['back-office/format-update']) . '/" + row.id;
                        var delUrl  = "' . Url::to(['back-office/format-delete']) . '/" + row.id;
