...
<div class="site-login d-flex flex-column justify-content-center align-items-center">
    <div class="w-100 d-flex flex-column align-items-center" style="max-width: 700px;min-width: 450px;">
        ...
        <div class="d-grid gap-2 mt-4">
            <?= Html::submitButton(
                ...
                Icon::widget(['icon' => 'bi-arrow-right', 'size' => Icon::SIZE_24, 'options' => ['class' => 'ms-4']]),
                ['class' => 'btn btn-primary rounded-pill btn-lg d-flex justify-content-center align-items-center', 'name' => 'login-button']
            ) ?>
        </div>

        <div class="text-center mt-3">
            <?= Html::a(Yii::t('app', 'Did you forget password?'), ['auth/request-password-reset'], ['class' => 'text-decoration-none small']) ?>
        </div>
