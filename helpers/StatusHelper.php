...
class StatusHelper
{
     ...
     */
    public static function statusesFilters($filter = null): array
    {
     ...
     */
    public static function getRange($filter = null): array
    {
        return array_keys(self::statusesFilters($filter));
    }
}